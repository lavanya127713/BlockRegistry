...
class _UserDashBoardState extends State<UserDashBoard> {
  ...
  Future<bool> uploadDocument() async {
    ...
    if (isFilePicked) {
      try {
        cid = await uploadDocument2(docuName, context,
            documentFile: documentFile);
        print("response from file upload $cid");
          ...
          child: GridView.builder(
            ...
            itemBuilder: (context, index) {
              return landWid(
                ...
                List<String> allLatiLongi =
                    landInfo[index][4].toString().split('|');

                LandInfo _landinfo = LandInfo(
                    landInfo[index][1].toString(),
                    landInfo[index][2].toString(),
                    landInfo[index][3].toString(),
                    landInfo[index][5].toString(),
                    landInfo[index][6].toString(),
                    landInfo[index][7].toString(),
                    landInfo[index][8],
                    landInfo[index][9].toString(),
                    landInfo[index][10]);
                Navigator.push(
                    context,
                    MaterialPageRoute(
